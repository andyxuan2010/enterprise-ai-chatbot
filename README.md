...
5. The app optionally reranks the broader hybrid candidate set with the configured Azure OpenAI chat deployment.
6. The app sends the reranked chunks to the chat deployment for final answer generation.
7. The browser renders clickable source previews with markdown formatting and highlighted matching terms.
