...
9. The app sends the reranked chunks to the chat deployment for final answer generation.
10. The browser renders clickable source previews with markdown formatting, metadata, and highlighted matching terms.
