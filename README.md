...
Use `ENABLE_ADO_TERRAFORM_APPLY=true` to allow the Terraform Apply stage. Use `ENABLE_ADO_APP_DEPLOY=true` separately to allow the App Service package deployment stage.
