...
The App Service startup command is configured in [main.tf](./main.tf):
...
![Enterprise AI Chatbot on Azure architecture](./docs/images/enterprise-ai-chatbot-architecture.svg)
...
| [environments/prod](./environments/prod) | Production backend and tfvars. |
...
The pipeline expects the shared template repo and the Azure service connections configured in the YAML.
