...
In Azure DevOps, set this as a regular pipeline variable:

```text
APP_SERVICE_CUSTOM_HOSTNAME = chat-sbx.example.com
```

The pipeline translates `APP_SERVICE_CUSTOM_HOSTNAME` into Terraform's `TF_VAR_app_service_custom_hostname` before plan/apply.
