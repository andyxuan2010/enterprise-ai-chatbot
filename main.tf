...
resource "azapi_resource_action" "rag_search_query_key" {
  count = var.create_azure_search_query_key && var.azure_search_query_key == "" && var.landingzone_azure_ai_search_enabled && length(data.azurerm_search_service.azure_ai_search) > 0 ? 1 : 0
